...
public class DonHangApi {
	...
	public void xacNhanHoanThanhDon(@RequestParam("donHangId") long donHangId,
	    ...
	    for (ChiTietDonHang ct : dh.getDanhSachChiTiet()) {
	        ...
	        if (sp.getDonViKho() < ct.getSoLuongNhanHang()) {
	            isOutOfStock = true;
	            break;
	        }
	    }
	    ...
	    if (!isOutOfStock) {
	    	...
	    	dh.setTrangThaiDonHang("Hết hàng");
	    }
	...
	public List<Object> tk() {
		return donHangService.thongKeDonHangTheoThang();
	}
	
	@GetMapping("/remaining")
	public List<Object> remain() {
		return donHangService.thongKeSoLuongConLaiCuaSanPhamTrongKho();
	}
	
	@GetMapping("/outofstock")
	public List<Object> outofstock() {
		return donHangService.thongKeHetHang();
	}
}
